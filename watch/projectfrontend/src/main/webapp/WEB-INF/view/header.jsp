...
<div class="navbar-header">
				<a href="" class="navbar-brand"><img src="<c:url value='/resources/images/logo.jpg'></c:url>" alt="NIIT" height="30px" width="80px"></a>
...
<li><a href="<c:url value='/contactus'></c:url>">ContactUs</a></li>
